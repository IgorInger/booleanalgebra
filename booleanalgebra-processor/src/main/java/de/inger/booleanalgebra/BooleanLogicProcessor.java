...
public class BooleanLogicProcessor implements
		Processor<BALexer, BAParser, BATreeParser> {
	...
	public BAParser getParser(TokenStream tokenStream) {
		return new BAParser(tokenStream);
	}

	@Override
	public BALexer getLexer(CharStream charStream) {
		BALexer lexer = new BALexer(charStream);
		return lexer;
	}
	...
	public BATreeParser getTreeParser(TreeNodeStream treeNodeStream) {
		BATreeParser treeParser = new BATreeParser(treeNodeStream);
		return treeParser;
	}

	public BATreeParser getTreeParserForString(String text) throws RecognitionException, EmptyTreeException {
	...
	public BATreeParser getTreeParserForFile(String fileName) throws IOException, RecognitionException,
			EmptyTreeException {
